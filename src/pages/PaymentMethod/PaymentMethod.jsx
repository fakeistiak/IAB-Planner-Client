...
const PaymentMethod = () => {
    return (
        <div className="bg-gray-900 text-white">
            <h1 className="text-center text-4xl font-bold py-4"><span className="text-pink-500">Payment </span>Method</h1>
           <div>
    <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center justify-center space-y-8 lg:-mx-4 lg:flex-row lg:items-stretch lg:space-y-0">
            <div className="flex flex-col w-full max-w-sm p-8 space-y-8 text-center bg-white border-2 border-gray-200 rounded-lg lg:mx-4 dark:bg-gray-900 dark:border-gray-700">
                ...
                <Link to="/form" className="inline-flex items-center justify-center px-4 py-2 font-medium text-white uppercase transition-colors bg-blue-500 rounded-lg hover:bg-blue-700 focus:outline-none">
                    Start free
                </Link>
            </div>
